package fr.tathan.halloween_mood.common.particles;
...
public class FallingLeavesParticle extends TextureSheetParticle {
    ...
    public FallingLeavesParticle(ClientLevel pLevel, double pX, double pY, double pZ    , SpriteSet pSpriteSet) {
        ...
        float f = this.random.nextBoolean() ? 0.04F : 0.060F;
        this.quadSize = f;
        this.setSize(f, f);
        this.friction = 1.0F;
    }
